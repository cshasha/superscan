...
pd.DataFrame(data={'cell':data.index,'broad_label':Y_pred1, 'entropy_score_broad': ent1, 'confidence_broad': con1,
                   'fine_label':Y_pred2, 'entropy_score_fine': ent2,'confidence_fine': con2}).to_csv(opt.out_prefix + '_superscan.csv',index=False)
